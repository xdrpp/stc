...
func (arg SetTrustLineFlags) To_Operation_Body() (ret stx.XdrAnon_Operation_Body) {
	ret.Type = stx.SET_TRUST_LINE_FLAGS
	*ret.SetTrustLineFlagsOp() = stx.SetTrustLineFlagsOp(arg)
	return
}
...
func (arg LiquidityPoolDeposit) To_Operation_Body() (ret stx.XdrAnon_Operation_Body) {
	ret.Type = stx.LIQUIDITY_POOL_DEPOSIT
	*ret.LiquidityPoolDepositOp() = stx.LiquidityPoolDepositOp(arg)
	return
}
...
func (arg LiquidityPoolWithdraw) To_Operation_Body() (ret stx.XdrAnon_Operation_Body) {
	ret.Type = stx.LIQUIDITY_POOL_WITHDRAW
	*ret.LiquidityPoolWithdrawOp() = stx.LiquidityPoolWithdrawOp(arg)
	return
}

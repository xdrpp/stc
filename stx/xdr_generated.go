...
func (v *TrustLineFlags) XdrInitialize() {
	...
	case AUTHORIZED_FLAG, AUTHORIZED_TO_MAINTAIN_LIABILITIES_FLAG:
	default:
...
var _XdrTags_XdrAnon_AllowTrustOp_Asset = map[int32]bool{
	XdrToI32(ASSET_TYPE_CREDIT_ALPHANUM4): true,
	XdrToI32(ASSET_TYPE_CREDIT_ALPHANUM12): true,
}
func (_ XdrAnon_AllowTrustOp_Asset) XdrValidTags() map[int32]bool {
	return _XdrTags_XdrAnon_AllowTrustOp_Asset
}
...
func (u *XdrAnon_AllowTrustOp_Asset) XdrUnionTag() XdrNum32 {
	return XDR_AssetType(&u.Type)
}
func (u *XdrAnon_AllowTrustOp_Asset) XdrUnionTagName() string {
	return "Type"
}
func (u *XdrAnon_AllowTrustOp_Asset) XdrUnionBody() XdrType {
	switch u.Type {
	case ASSET_TYPE_CREDIT_ALPHANUM4:
...
type XdrType_XdrAnon_AllowTrustOp_Asset = *XdrAnon_AllowTrustOp_Asset
func (v *XdrAnon_AllowTrustOp_Asset) XdrPointer() interface{} { return v }
func (XdrAnon_AllowTrustOp_Asset) XdrTypeName() string { return "XdrAnon_AllowTrustOp_Asset" }
...
func (v *AllowTrustOp) XdrRecurse(x XDR, name string) {
	...
	x.Marshal(x.Sprintf("%sasset", name), XDR_XdrAnon_AllowTrustOp_Asset(&v.Asset))
...
var StellarCommit = "cc7a7ae37b689adb27fa1241303982149526b078"
